...
| S1 | Story-Intro | 배경, 소라 아이콘, 상황 1줄, [옷 고르러 가기] |
...
{ "ria": { "name": "리아", "color": "#F4A7B9", "portrait": "assets/characters/ria/portrait.png",
  ...
  "prince": { "name": "???", "reveal_name": "레오", "color": "#2E3A59", "portrait": "..." } }
```
...
| Stage | 장소 | 사건 | 등장 | 떡밥 |
|---|---|---|---|---|
| 1 첫 번째 별빛 파티 | 스튜디오→광장 | 파티 불이 꺼짐, 낯선 남자가 침착하게 해결 | 소라·현·예나·레오 | 왜 침착하지? |
| 2 카페에서의 우연 | 문라이트 카페 | 남자가 물건을 떨어뜨리고 리아가 주워줌. 회중시계 | 소라·레오·예나(스쳐감) | 시계에 왕궁 문양? |
| 3 이름을 아는 남자 | 플라워 가든 | 남자가 리아의 이름을 부름. 리아는 말한 적 없음 | 소라·레오·현 | 왜 내 이름을? → TO BE CONTINUED |
