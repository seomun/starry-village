...
## 배경 프롬프트 (720×1280 세로)
```
스타리빌리지 배경, 파스텔 수채 애니 풍, 인물 없음, 세로 720×1280, 화면 하단 1/3 은 단순하게(대사창 자리).
<plaza_night: 별이 쏟아지는 밤 광장, 등불과 무대> / <cafe: 문라이트 카페 내부, 창가 자리, 디저트> / <garden: 플라워 가든, 별 모양 꽃, 낮>
<post_office: 별빛 우체국 내부, 편지 선반과 카운터, 별 문양 우표> / <star_house: 리아의 방, 밤, 창밖으로 시계탑, 쿠션과 별 조명>
```
